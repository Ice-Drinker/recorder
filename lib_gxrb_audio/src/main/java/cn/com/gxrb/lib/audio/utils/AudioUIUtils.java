package cn.com.gxrb.lib.audio.utils;
...
public class AudioUIUtils {
    ...
    public static final void toastLongMessage(final String message) {
        BackgroundTasks.getInstance().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mToast = Toast.makeText(AudioConfig.Companion.get().context, message,
                        Toast.LENGTH_LONG);
                mToast.show();
            }
        });
    ...
    public static int getPxByDp(int dp) {
        float scale = AudioConfig.Companion.get().context.getResources().getDisplayMetrics().density;
